# first install all dependencies like git, docker, starship nvim, ripgrep, pthon env, neofetch, zsh etc
...
# 
# TODO:
# change user dirs for lowercase letters and add projects as main also. Do this first!! coz files can go wrong folders
#
# then check if there is gui if yes install things like:
# gimp, brave, firefox, chromium, dbeaver, discord, kitty, inkscape, libre office, kdenlive, vlc, 
